...
namespace Matrix
{
    public partial class Update : Form
    {
        ...
        private void PaidBox_TextChanged_1(object sender, EventArgs e)
        {
            AppSettings.NumericOnly(PaidBox);
        }

        private void DuesBox_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void WeightBox_TextChanged_1(object sender, EventArgs e)
        {
